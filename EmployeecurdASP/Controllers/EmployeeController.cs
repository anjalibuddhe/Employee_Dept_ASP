...
namespace EmployeecurdASP.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(IConfiguration configuration, Microsoft.AspNetCore.Hosting.IHostingEnvironment env)
        {
            ...
            deptCurd = new DeparmentCurd(this.configuration);
            this.env = env;
        }
        // GET: EmployeeController
        public ActionResult Index()
        {
            var model=empCrud.GetEmployees();
            return View(model);
        }
        ...
        {
            ViewBag.Department = deptCurd.GetDepartments();
            return View();
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.Departments = deptCurd.GetDepartments();
